...
void AAuraPlayerController::AbilityInputTagReleased(FGameplayTag InputTag)
{
	...
	if (!bTargeting && !bShiftKeyDown) // If targeting (using UnderCursor()) activate ability
	{
...
void AAuraPlayerController::AbilityInputTagHeld(FGameplayTag InputTag)
{
	...
	if (bTargeting || bShiftKeyDown) // If targeting (using UnderCursor()) activate ability or Shift Key is pressed
	{
		if (GetASC())
		{
			GetASC()->AbilityInputTagHeld(InputTag);
