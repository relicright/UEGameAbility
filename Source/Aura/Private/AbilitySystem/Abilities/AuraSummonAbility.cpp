...
TArray<FVector> UAuraSummonAbility::GetSpawnLocation()
{
	...
	//const FVector RightOfSpread = Forward.RotateAngleAxis(SpawnSpread / 2.5f, FVector::UpVector);
	const FVector LeftOfSpread = Forward.RotateAngleAxis(-SpawnSpread / 2.5f, FVector::UpVector);
